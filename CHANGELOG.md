...
| Cursor CLI 2026.08.11 | `agent plugin marketplace add https://github.com/proyecto26/seldon` | ✅ marketplace indexed: "Added marketplace seldon-marketplace (1 plugin) — seldon" with the manifest description. Plugin install goes through the interactive `/plugins` picker and was **not exercised** headlessly (`--plugin-dir` / `settings.json` `enabled_plugins` tests were inconclusive because the headless skill list is truncated at 146 of 360 skills on this machine). |
